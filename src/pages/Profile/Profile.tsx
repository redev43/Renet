...
import ISettingsForm from "@/interfaces/forms/settings.form";
import IPost from "@/interfaces/post.interface";
import styles from "@/pages/Profile/Profile.module.scss"
import AvatarChange from "@/ui/AvatarChange/AvatarChange";
import ChangeUsername from "@/ui/ChangeUsername/ChangeUsername";
...
const Profile = () => {
  ...
  const onSubmit: SubmitHandler<ISettingsForm> = async data => {
    // Тут отправляешь запрос на изменение данных пользователя. Все введенные данные хранятся в data
  }
